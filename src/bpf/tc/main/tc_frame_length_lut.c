...
// Frame-type -> number of leading varints (RFC 9000). Intended for walking multi-frame
// payloads; current relay assumes stream frames arrive in their own packets.
        ...
        switch (frame_id) {
                ...
                */
                case ACK_FRAME:
                        return 5;
                case ACK_ECN_FRAME:
                        return 8; // TODO: ACK Range (two varints) and ECN Counts (three varints)
